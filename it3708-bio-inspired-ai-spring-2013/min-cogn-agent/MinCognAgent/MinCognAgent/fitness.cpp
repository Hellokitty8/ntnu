...
void fitness::moveObject(){
	...
	*/
	//Measure to handle vertical movement speed > 1
				//if(Object_Height > GAME_HEIGHT-1)	
				//	Object_Height  = GAME_HEIGHT-1;
}
...
void fitness::initializeCTRNN(vector<float> phenom){
	...
	gameController.SetCircuitSize(9);

	//Set Connection Weights
	gameController.SetConnectionWeight(1, 6, phenom[0]);
	gameController.SetConnectionWeight(1, 7, phenom[1]);
	gameController.SetConnectionWeight(2, 6, phenom[2]);
	gameController.SetConnectionWeight(2, 7, phenom[3]);
	gameController.SetConnectionWeight(3, 6, phenom[4]);
	gameController.SetConnectionWeight(3, 7, phenom[5]);
	gameController.SetConnectionWeight(4, 6, phenom[6]);
	gameController.SetConnectionWeight(4, 7, phenom[7]);
	gameController.SetConnectionWeight(5, 6, phenom[8]);
	gameController.SetConnectionWeight(5, 7, phenom[9]);

	//Hidden Layer -> Hidden Layer
	gameController.SetConnectionWeight(6, 6, phenom[10]);
	gameController.SetConnectionWeight(6, 7, phenom[11]);
	gameController.SetConnectionWeight(7, 6, phenom[12]);
	gameController.SetConnectionWeight(7, 7, phenom[13]);

	//Hidden Layer -> Motor Output Layer
	gameController.SetConnectionWeight(6, 8, phenom[14]);
	gameController.SetConnectionWeight(6, 9, phenom[15]);
	gameController.SetConnectionWeight(7, 8, phenom[16]);
	gameController.SetConnectionWeight(7, 9, phenom[17]);

	//Motor Output Layer -> Motor Output Layer
	gameController.SetConnectionWeight(8, 8, phenom[18]);
	gameController.SetConnectionWeight(8, 9, phenom[19]);
	gameController.SetConnectionWeight(9, 8, phenom[20]);
	gameController.SetConnectionWeight(9, 9, phenom[21]);
	
	//Set Biases
	gameController.SetNeuronBias(6, phenom[22]);
	gameController.SetNeuronBias(7, phenom[23]);
	gameController.SetNeuronBias(8, phenom[24]);
	gameController.SetNeuronBias(9, phenom[25]);

	//Set Neuron Gains
	gameController.SetNeuronGain(6, phenom[26]);
	gameController.SetNeuronGain(7, phenom[27]);
	gameController.SetNeuronGain(8, phenom[28]);
	gameController.SetNeuronGain(9, phenom[29]);

	//Set Time Constants
	gameController.SetNeuronTimeConstant(6, phenom[30]);
	gameController.SetNeuronTimeConstant(7, phenom[31]);
	gameController.SetNeuronTimeConstant(8, phenom[32]);
	gameController.SetNeuronTimeConstant(9, phenom[33]);
