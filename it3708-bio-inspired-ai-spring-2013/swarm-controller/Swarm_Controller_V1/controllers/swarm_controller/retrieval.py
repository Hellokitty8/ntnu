...
class retrieval(object):
    ...
    def __push_box(self, IR_sensor_value, IR_treshold):
        ...
        if(IR_sensor_value[0] < IR_treshold) and (IR_sensor_value[7] < IR_treshold):
    ...
    def swarm_retrieval(self, IR_sensor_value, IR_treshold):
        ...
        if (self.push):
            self.__push_box(IR_sensor_value,  IR_treshold)
        else:
            self.__converge_to_box(IR_sensor_value, IR_treshold)
